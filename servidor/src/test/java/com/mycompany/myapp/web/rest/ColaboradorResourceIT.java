...
class ColaboradorResourceIT {
    ...
    void putExistingColaborador() throws Exception {
        ...
        updatedColaborador.nombreColaborador(UPDATED_NOMBRE_COLABORADOR).numTelefono(UPDATED_NUM_TELEFONO).correo(UPDATED_CORREO);
    ...
    void partialUpdateColaboradorWithPatch() throws Exception {
        ...
        partialUpdatedColaborador.nombreColaborador(UPDATED_NOMBRE_COLABORADOR);
