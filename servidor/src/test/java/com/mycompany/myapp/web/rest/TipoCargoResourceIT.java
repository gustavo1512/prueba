...
import com.mycompany.myapp.repository.TipoCargoRepository;
...
class TipoCargoResourceIT {
    ...
    private static final Double DEFAULT_PRECIO_HORA = 1D;
    private static final Double UPDATED_PRECIO_HORA = 2D;
    ...
    public static TipoCargo createEntity(EntityManager em) {
        TipoCargo tipoCargo = new TipoCargo().nombreCargo(DEFAULT_NOMBRE_CARGO).precioHora(DEFAULT_PRECIO_HORA);
        return tipoCargo;
    }
    ...
    public static TipoCargo createUpdatedEntity(EntityManager em) {
        TipoCargo tipoCargo = new TipoCargo().nombreCargo(UPDATED_NOMBRE_CARGO).precioHora(UPDATED_PRECIO_HORA);
        return tipoCargo;
    }
    ...
    void createTipoCargo() throws Exception {
        ...
        assertThat(testTipoCargo.getPrecioHora()).isEqualTo(DEFAULT_PRECIO_HORA);
    }
    ...
    void getAllTipoCargos() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].precioHora")
            .value(hasItem(DEFAULT_PRECIO_HORA.doubleValue()));
    }
    ...
    void getTipoCargo() {
        ...
        webTestClient
            ...
            .jsonPath("$.precioHora")
            .value(is(DEFAULT_PRECIO_HORA.doubleValue()));
    }
    ...
    void putExistingTipoCargo() throws Exception {
        ...
        updatedTipoCargo.nombreCargo(UPDATED_NOMBRE_CARGO).precioHora(UPDATED_PRECIO_HORA);
        ...
        assertThat(testTipoCargo.getPrecioHora()).isEqualTo(UPDATED_PRECIO_HORA);
    }
    ...
    void fullUpdateTipoCargoWithPatch() throws Exception {
        ...
        partialUpdatedTipoCargo.nombreCargo(UPDATED_NOMBRE_CARGO).precioHora(UPDATED_PRECIO_HORA);
