...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TipoCargo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .flatMap(exists -> {
                ...
                Mono<TipoCargo> result = tipoCargoRepository
                    ...
                    .map(existingTipoCargo -> {
                        ...
                        if (tipoCargo.getPrecioHora() != null) {
                            existingTipoCargo.setPrecioHora(tipoCargo.getPrecioHora());
                        }
