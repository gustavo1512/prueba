...
/**
 * Spring Data R2DBC custom repository implementation for the Tarifa entity.
 */
...
class TarifaRepositoryInternalImpl extends SimpleR2dbcRepository<Tarifa, Long> implements TarifaRepositoryInternal {
    ...
    RowsFetchSpec<Tarifa> createQuery(Pageable pageable, Condition whereClause) {
        ...
        String select = entityManager.createSelect(selectFrom, Tarifa.class, pageable, whereClause);
