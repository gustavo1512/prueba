...
import { PersonaService, RestPersona } from './persona.service';

const requireRestSample: RestPersona = {
  ...sampleWithRequiredData,
  fechaNacimiento: sampleWithRequiredData.fechaNacimiento?.toJSON(),
};
