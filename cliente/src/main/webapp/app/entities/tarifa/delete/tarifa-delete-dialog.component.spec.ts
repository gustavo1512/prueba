...
describe('Tarifa Management Delete Component', () => {
  let comp: TarifaDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TarifaDeleteDialogComponent],
      providers: [NgbActiveModal],
    })
      .overrideTemplate(TarifaDeleteDialogComponent, '')
      .compileComponents();
